...
import { camPos, enableMouse, updateCameraPosition } from "../core/input.js";
...
const room = createRect(gl, 60, 30, 90);
...
function render(){
    ...
    const dir = updateCameraPosition(); // atualiza camPos e retorna direção
